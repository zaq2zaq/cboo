                ...
                productStore.count().onsuccess = (e) => {
                    if (e.target.result === 0) {
                        ...
                        const defaultProducts = [
                            { shop_id: 1, sku: "XB-2301", name: "法式乐福鞋", tags: ["头层牛皮", "手工缝线"], sizeRange: "34-39", colors: [{ name: "黑色", sizeRange: "34-39", stockMap: {34:12,35:20,36:8,37:15,38:10,39:5} }, { name: "白色", sizeRange: "34-39", stockMap: {34:8,35:14,36:22,37:9,38:6,39:3} }], costPrice: 129, salePrices: { retail: 299, wholesale: 168, discount: 239 }, status:1, create_time:Date.now() - 86400000, update_time:Date.now(), submitter:"admin" },
                            { shop_id: 1, sku: "XB-2307", name: "复古切尔西靴", tags: ["加绒内里", "耐磨大底"], sizeRange: "35-40", colors: [{ name: "棕色", sizeRange: "35-40", stockMap: {35:8,36:15,37:12,38:20,39:6,40:4} }], costPrice: 189, salePrices: { retail: 399, wholesale: 228, discount: 329 }, status:1, create_time:Date.now() - 43200000, update_time:Date.now(), submitter:"admin" },
                            { shop_id: 1, sku: "XB-2518", name: "厚底松糕乐福鞋", tags: ["厚底显高", "软垫"], sizeRange: "22-26", colors: [{ name: "米色", sizeRange: "22-26", stockMap: {22:8,23:15,24:20,25:12,26:7} }], costPrice: 149, salePrices: { retail: 269, wholesale: 149, discount: 199 }, status:1, create_time:Date.now(), update_time:Date.now(), submitter:"admin" }
                        ];
